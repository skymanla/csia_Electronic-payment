...
switch ($REQUEST_METHOD) {
	case "GET":
		...
		$tpl->setLayout('sub');
		$tpl->define("CONTENT","/html/online3hs/read2.htm");
		...
		if($_SESSION[acc_tmp1]==7 || $_SESSION[acc_tmp2]==99 || $_SESSION[acc_tmp3]==8 || $_SESSION[acc_tmp5]==98){
			...
			$tpl->assign(array("mody_link"=>"/?act=online3hs.modify2&mcode=$code&num=$num", "mody_title"=>"수정"));
		...
		if($_SESSION[acc_tmp2]==99 || $_SESSION[acc_tmp3]==8){//$_SESSION[acc_tmp1]==7 || 
			...
			$tpl->assign(array("back_url"=>"/?act=online3hs.giveback2&mcode=$code&num=$num","back_title"=>"반려"));
		}
...
function _format_data(&$arr) {
	...
	if($_SESSION[ADMIN] || $_SESSION[acc_tmp1]==7 || $_SESSION[acc_tmp2]==99 || $_SESSION[acc_tmp3]==8 || $_SESSION[acc_tmp5]==98){
		$arr['deleteUrl'] = "/?act=online3hs.delete2&mcode=".$mcode."&num=".$arr['num_serial']."&id=".$arr['str_id']."&id2=".$arr['str_loginid'];
	}else{
		$arr['deleteUrl'] = "/?act=online3hs.delete2&mcode=".$mcode."&num=".$arr['num_serial'];
	}
